...
#### Cordova iOS 8.0 migration

-   Add imports for UIKit & Foundation
-   Update CDVPluginResult usage
-   Use CDVCommandStatus enum aliases
-   Use scene-aware window bounds and orientation
-   Update engine requirements for Cordova iOS 8.0 and iOS 13.0
